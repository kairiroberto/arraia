...
public class WebUsuarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_usuario);
        context = this;
        ...
        wvPrincipal.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                Toast.makeText(WebUsuarioActivity.this, url, Toast.LENGTH_LONG).show();
            }
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                sb.append("\nurl = " + failingUrl);
                Toast.makeText(WebUsuarioActivity.this, sb.toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
